...
import { Plus, Trash2, Pencil, Tractor, X, ChevronDown, ChevronUp } from 'lucide-react'
...
const CATEGORIAS = ['Equipamentos Móveis', 'Equipamentos Fixos', 'Benfeitorias', 'Outros']
              ...
              {!editando && (
                <div className="border-t border-gray-100 pt-4 space-y-3">
                  <label className="flex items-center gap-3 cursor-pointer select-none">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-700">Gerar lançamento de aquisição</p>
